...
Screenshot 2021-09-09 at 14 48 29
...
Note 2: log⁡(n)<n → log⁡(log⁡(n)) < log⁡(n) have as log is monotonic increasing function
Note 3: n! = O(n^n)
Screenshot 2021-09-09 at 14 56 21

3.2.2. Lower Bound (Omega) Notation
3.2.3. Tight Asymptotic (Theta) Bound
Screenshot 2021-09-09 at 14 53 59

Exercise of Big O, Omega and Theta
Determine which relationship is correct and briefly explain why
Screenshot 2021-09-09 at 15 00 56
...
Screenshot 2021-10-06 at 22 46 16
...
Used set, instead of list, to make a visited set for marking the node is visted. For example: Open the Lock, Number of Islands,
def BFS(root, target):
    queue = dequeue()  #store all nodes which are waiting to be processed
...
Size: How many cells are there image
(Back to top)
...
Computer registers: head of the Linked List image
3.1. Advantage vs Disadvantage of Linked List
...
Screenshot 2021-09-12 at 22 13 43
...
Screenshot 2021-09-13 at 14 36 43
...
Example: Design Circular Queue Please refer the link for Circular Queue animation
...
Screenshot 2021-09-13 at 17 49 55

6.1. Binary Tree
An empty tree or a node with at most 2 branches
Screenshot 2021-09-13 at 17 54 50
...
Screenshot 2021-09-13 at 18 02 13
...
Screenshot 2021-09-13 at 18 02 43
...
If you handle this tree in postorder, you can easily handle the expression using a stack. Each time when you meet a operator, you can just pop 2 elements from the stack, calculate the result and push the result back into the stack. IMG_0012
6.3. Level-order Traversal
...
6.4.3. BST - Deletion
Screenshot 2021-09-23 at 23 40 44
...
example. A max-heap in the previous example can be represented by a list [None, 6, 5, 3, 4, 2, 1].
...
example. i = 4, value = 17 → parent = i//2 Left Child = 2*i, Right Child = 2*i+ 1
Height of Heap
...
Screenshot 2021-09-14 at 14 56 28
...
insert is to append a new element at the end of the list.
...
pop is to return the maximum key in the heap, which is contained in the root of the heap, at index 1.
