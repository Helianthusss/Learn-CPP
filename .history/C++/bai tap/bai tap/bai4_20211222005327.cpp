...
//cau b
void xuat(SV &a){
    cout<<a.hoten<<setw(15)<<a.dt<<setw(15)<<a.dnn<<setw(15)<<a.dtb<<setw(15)<<a.xeploai<<endl;
}
void inDS(SV a[], int n)
{
	cout<<" DANH SACH SINH VIEN LA: "<<endl;
    cout<<"Ho ten"<<setw(15)<<"Diem tin"<<setw(15)<<"Diem Ngoai Ngu"<<setw(15)<<"Diem TB"<<setw(15)<<"Xep loai"<<endl;
	for(int i=0;i<n;i++){   
        xuat(a[i]);
	}
}
