...
int main(){
    ...
    Sach a[n];
    nhapDS(a,n);
    cout<<"Xuat danh sach quyen sach!"<<endl;
    xuatDS(a,n);
    cout<<"Tim sach theo ma so!"<<endl;
    timSachTheoMaSo(a,n);
    cout<<"Tim cac cuon sach co cung ten tac gia!"<<endl;
    timSachTheoTacGia(a,n);
    cout<<"Loc cac cuon sach co cung nam xuat ban!"<<endl;
    timSachTheoNamXuatBan(a,n);
    cout<<"Tim sach theo nhan de!"<<endl;
