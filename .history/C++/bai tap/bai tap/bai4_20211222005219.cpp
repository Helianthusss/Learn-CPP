...
//cau b
void xuat(SV &a){
    cout<<a.hoten<<setw(5)<<a.dt<<setw(10)<<a.dnn<<setw(15)<<a.dtb<<setw(10)<<a.xeploai<<endl;
}
void inDS(SV a[], int n)
{
	cout<<" DANH SACH SINH VIEN LA: "<<endl;
    cout<<"Ho ten"<<setw(5)<<"Diem tin"<<setw(10)<<"Diem Ngoai Ngu"<<setw(15)<<"Diem TB"<<setw(10)<<"Xep loai"<<endl;
	for(int i=0;i<n;i++){   
        xuat(a[i]);
	}
}
