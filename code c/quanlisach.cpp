...
void sapXepMaSach(Sach *danhsach, int soluong);
void hienthiThongtinTheoHangNgang(Sach *danhsach, int soluong);
void timSachTheoMaSach(Sach *danhsach, int soluong);
void thongKeSachTheoTheLoai(Sach *danhsach,int soluong);
void xoaSach(Sach *danhsach,int soluong);
void suaTenSach(Sach *danhsach,int soluong);
void ghiFile(Sach *danhsach, int n);
void pressAnyKey();
void menu();
int main(){
	system("color 72");
...
void menu(){
	Sach *danhsach;
	int soluong,key;
	danhsach = (Sach*) malloc(sizeof(Sach));
    int flat = 1;
    bool daNhap = false;
    while(flat){
        system("cls");
        ...
        switch(key){
			...
			case 2:
                if(daNhap){
                    ...
                    sapXepMaSach(danhsach,soluong);
                    hienthiThongtinTheoHangNgang(danhsach,soluong);
                }else{
            ...
            case 3:
                if(daNhap){
                    ...
                    timSachTheoMaSach(danhsach,soluong);
                }else{
                    printf("\n   Nhap danh sach sach truoc!!!!");
                }
                pressAnyKey();
            ...
            case 4:
                if(daNhap){
                    ...
                    thongKeSachTheoTheLoai(danhsach,soluong);
                }else{
                    printf("\n   Nhap danh sach sach truoc!!!!");
                }
                pressAnyKey();
...
void sapXepMaSach(Sach *danhsach, int soluong){
	...
	for(int i=0; i<soluong-1; i++){
		for(int j=i+1; j<soluong; j++){
			if(strcmp((danhsach+i)->maSach,(danhsach+j)->maSach)>0){
				temp = *(danhsach+i);
...
void thongKeSachTheoTheLoai(Sach *danhsach,int soluong){
	...
	printf("\n +============================================+");
	for(int i=0;i<soluong;i++){
		if(strcmp((danhsach+i)->theLoai,theLoaiSach)==0){
			bienKT++;
	...
	for(int i=0;i<soluong;i++){
		if(strcmp((danhsach+i)->maSach,maSach)==0){
	        for(bienLap=i;bienLap<soluong;i++){
	            *(danhsach+bienLap)=*(danhsach+bienLap+1);
	            soluong=soluong-1;  
	        }
		printf("\n   Da xoa xong");
		bienKT++;
